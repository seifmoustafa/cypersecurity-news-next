...
export default function PresentationPageClient({ params }: { params: { id: string } }) {
  ...
  return (
    <MainLayout>
      <article className="pt-24 pb-16 bg-gradient-to-br from-purple-50/30 via-white to-blue-50/30 dark:from-purple-950/30 dark:via-slate-900 dark:to-blue-950/30">
