...
export default function StandardPageClient({ params }: { params: { category: string; standard: string } }) {
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {controls.map((control) => (
                  <Link href={`/standards/${params.category}/${params.standard}/${control.id}`} key={control.id}>
