...
import { GraduationCap, ArrowRight, ArrowLeft, Star, BookOpen, Search, Calendar } from "lucide-react"
import Breadcrumbs from "@/components/breadcrumbs"
import { useLectureCategories } from "@/core/hooks/use-lecture-categories"
import { useDebounce } from "@/hooks/use-debounce"

export default function SimpleLectureCategoriesPage() {
            ...
            <div className="flex items-center gap-4">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder={language === "ar" ? "ابحث في فئات المحاضرات..." : "Search lecture categories..."}
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 dark:from-slate-950 dark:via-gray-950 dark:to-slate-900 flex items-center justify-center">
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-muted-foreground mb-2">
            {language === "ar" ? "حدث خطأ في تحميل فئات المحاضرات" : "Error loading lecture categories"}
          </h3>
