...
export default function SimplePresentationCategoriesPage() {
  ...
  const { categories, loading, error } = usePresentationCategories(1, 100, debouncedQuery)
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24 pb-8">
          ...
          <Breadcrumbs 
            items={[
              ...
              { label: language === "ar" ? "فئات العروض التقديمية" : "Presentation Categories" }
            ]} 
          />
            ...
            <div className="flex items-center gap-4">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder={language === "ar" ? "ابحث في فئات العروض التقديمية..." : "Search presentation categories..."}
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 dark:from-slate-950 dark:via-gray-950 dark:to-slate-900 flex items-center justify-center">
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-muted-foreground mb-2">
            {language === "ar" ? "حدث خطأ في تحميل فئات العروض التقديمية" : "Error loading presentation categories"}
          </h3>
              ...
              >
                ...
                <div className="relative aspect-video bg-gradient-to-br from-purple-500 to-pink-600">
                  ...
                  <div className="absolute top-4 right-4 bg-black/50 text-white text-xs px-3 py-1 rounded-full">
                    {language === "ar" ? "فئة عرض تقديمي" : "Presentation Category"}
                  </div>
                </div>
                ...
                <div className="p-8">
                  ...
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <div className="text-sm text-gray-500 dark:text-gray-400 mb-1 flex items-center gap-2">
                        <Calendar className="h-4 w-4" /> {new Date(category.createdAt).toLocaleDateString()}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-6 line-clamp-4">
                    {language === "ar" 
                      ? "استكشف مجموعة واسعة من العروض التقديمية التعليمية في مجال الأمن السيبراني" 
                      : "Explore a wide range of educational presentations in cybersecurity"
                    }
                  </div>
                  ...
                  <div className="inline-flex items-center justify-center w-full py-3 px-6 bg-gradient-to-r from-purple-500 to-pink-600 text-white font-semibold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg group/btn focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white/10 focus:ring-purple-400">
                    <span className="mr-2 rtl:mr-0 rtl:ml-2">
                      {language === "ar" ? "استكشف العروض التقديمية" : "Explore Presentations"}
                    </span>
                    {isRtl ? (
