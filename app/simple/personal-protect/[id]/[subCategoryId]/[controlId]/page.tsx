...
import { Play, Search, Calendar, ArrowRight, ArrowLeft, Eye, Users, Lock, Home, Settings, FileText, Video, Image, Download, ChevronRight, ChevronLeft, Clock, CheckCircle, Star, Zap, PlayCircle, BookOpen, Target, Shield, Award, TrendingUp, Sparkles } from "lucide-react"
import Link from "next/link"
import { useMemo, useState } from "react"
import Breadcrumbs from "@/components/breadcrumbs"

interface PersonalProtectControlStepsPageProps {
  params: Promise<{
    id: string
...
export default function PersonalProtectControlStepsPage({ params }: PersonalProtectControlStepsPageProps) {
  ...
  const { steps, loading, error, pagination } = usePersonalProtectControlSteps(controlId, query, currentPage, pageSize)
        ...
        <div className="container mx-auto px-4 pt-24 pb-8">
          ...
          <div className="max-w-4xl mx-auto text-center py-16">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
              {language === "ar" ? "خطأ في تحميل الخطوات" : "Error Loading Steps"}
            </h1>
      ...
      <div className="relative z-10 container mx-auto px-4 pt-24 pb-8">
          ...
          <form onSubmit={handleSearch} className="flex items-center gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder={language === "ar" ? "ابحث في الخطوات..." : "Search steps..."}
            ...
            <button
              type="submit"
              className="bg-gradient-to-r from-blue-500 to-purple-600 p-3 rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
        ...
        {pagination && (
          <div className="mb-6">
            <p className="text-gray-600 dark:text-gray-400">
              {language === "ar" 
                ? `تم العثور على ${pagination.itemsCount} خطوة`
                : `Found ${pagination.itemsCount} steps`
              }
            </p>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {sortedSteps.map((step, index) => {
            const displayName = language === "ar" ? step.name : (step.nameEn || step.name)
            const displaySummary = language === "ar" ? step.summary : (step.summaryEn || step.summary)
            
            return (
              <Link 
                key={step.id} 
                href={`/simple/personal-protect/${categoryId}/${subCategoryId}/${controlId}/${step.id}`} 
                className="group"
              ...
              >
                ...
                >
                  ...
                  <div className="relative aspect-video bg-gradient-to-br from-blue-500 to-purple-600">
                    ...
                    {/* Step Order Badge */}
                    <div className="absolute top-4 left-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white text-sm font-bold px-3 py-1 rounded-full flex items-center gap-1">
                  ...
                  <div className="p-8">
                    ...
                    <div className="inline-flex items-center justify-center w-full py-3 px-6 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg group/btn focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white/10 focus:ring-blue-400">
                      <span className="mr-2 rtl:mr-0 rtl:ml-2">
                        {language === "ar" ? "عرض الخطوة" : "View Step"}
                      </span>
                      {isRtl ? (
        ...
        {steps.length === 0 && !loading && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
              {language === "ar" ? "لا توجد خطوات" : "No Steps Found"}
            </h3>
            <p className="text-gray-600 dark:text-gray-400">
              {language === "ar" 
                ? "لم يتم العثور على أي خطوات تطابق البحث الخاص بك."
