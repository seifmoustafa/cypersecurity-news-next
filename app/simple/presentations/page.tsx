          ...
          <div className="flex items-center gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder={language === "ar" ? "ابحث في العروض..." : "Search presentations..."}
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  {filtered.length} {language === "ar" ? "عرض" : "presentations"}
                </p>
              </div>
            </div>
                ...
                <div className="p-8">
                  ...
                  >
                    ...
                    <span className="mr-2 rtl:mr-0 rtl:ml-2">
                      {language === "ar" ? "تحميل العرض" : "Download Presentation"}
                    </span>
                    {isRtl ? (
