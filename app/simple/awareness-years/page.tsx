...
import { Calendar, ArrowRight, ArrowLeft, Search, BookOpen } from "lucide-react"
import Breadcrumbs from "@/components/breadcrumbs"
import { useAwarenessYears } from "@/core/hooks/use-awareness"
import { useDebounce } from "@/hooks/use-debounce"

export default function SimpleAwarenessYearsPage() {
  ...
  const { data, loading, error } = useAwarenessYears(debouncedQuery, 1, 50)
  const years = data?.data || []

  const breadcrumbItems = [
    { label: t('nav.home'), href: "/simple" },
    { label: t('awareness.title'), href: "/simple/awareness" },
    { label: t('awareness.years') }
  ]
        ...
        <div className="container mx-auto px-4 pt-24 pb-8">
          ...
          <div className="max-w-4xl mx-auto text-center py-16">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
              {language === "ar" ? "خطأ في تحميل السنوات" : "Error Loading Years"}
            </h1>
            <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto">
              {language === "ar" 
                ? "حدث خطأ أثناء تحميل سنوات التوعية. يرجى المحاولة مرة أخرى."
                : "An error occurred while loading awareness years. Please try again."
              }
            </p>
            <Link 
      ...
      <div className="relative z-10 container mx-auto px-4 pt-24 pb-8">
        ...
        {/* <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            {language === "ar" 
              ? "استكشف نشرات التوعية الأمنية من خلال السنوات المختلفة"
        ...
        {years.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
              {t('awareness.noAwareness')}
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              {language === "ar" 
                ? "لم يتم العثور على سنوات التوعية."
                ...
                <div className="bg-white dark:bg-slate-800 rounded-3xl border-2 border-slate-200 dark:border-slate-700 shadow-lg hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-500 hover:scale-[1.02] h-full will-change-transform overflow-hidden">
                  ...
                  <div className="relative h-48 overflow-hidden rounded-t-3xl">
                    <div className="w-full h-full bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 flex items-center justify-center">
                      <Calendar className="h-20 w-20 text-blue-600 dark:text-blue-400" />
                    </div>
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
                      {language === "ar" 
                        ? "نشرات التوعية الأمنية لهذا العام"
                        : "Security awareness bulletins for this year"
                      }
                    </p>
