...
import { Newspaper, ArrowRight, ArrowLeft, Star, BookOpen, Search } from "lucide-react"
import Breadcrumbs from "@/components/breadcrumbs"
import { useNewsCategories } from "@/core/hooks/use-news-categories"
import { useDebounce } from "@/hooks/use-debounce"

export default function SimpleNewsCategoriesPage() {
  ...
  const { categories, loading, error } = useNewsCategories(1, 100, debouncedQuery)
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24 pb-8">
          ...
          <Breadcrumbs 
            items={[
              ...
              { label: language === "ar" ? "فئات الأخبار" : "News Categories" }
            ]} 
          />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 dark:from-slate-950 dark:via-gray-950 dark:to-slate-900 flex items-center justify-center">
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-muted-foreground mb-2">
            {language === "ar" ? "حدث خطأ في تحميل فئات الأخبار" : "Error loading news categories"}
          </h3>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              {debouncedQuery
                ...
                : (language === "ar"
                    ? "لم يتم العثور على أي فئات أخبار"
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    <div className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-6 line-clamp-3">
                      {language === "ar" 
                        ? "تصفح آخر الأخبار في هذه الفئة" 
                        : "Browse latest news in this category"}
                    </div>
