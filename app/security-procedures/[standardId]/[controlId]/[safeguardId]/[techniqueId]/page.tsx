...
interface PageProps {
  params: Promise<{ standardId: string; controlId: string; safeguardId: string; techniqueId: string }>
}

export default async function ImplementationStepsPage({ params }: PageProps) {
  const { standardId, controlId, safeguardId, techniqueId } = await params
