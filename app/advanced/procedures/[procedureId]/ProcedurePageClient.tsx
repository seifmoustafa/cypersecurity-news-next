...
import { ArrowLeft, ArrowRight, Calendar, FileText, Shield } from "lucide-react"
...
export default function ProcedurePageClient({ procedure }: ProcedurePageClientProps) {
  ...
  useEffect(() => {
    const fetchControls = async () => {
      try {
        const controlsData = await container.services.procedures.getControlsByProcedureId(procedure.id, 1, 100)
  ...
  const title = language === "ar" ? procedure.nameAr || procedure.nameEn : procedure.nameEn || procedure.nameAr
