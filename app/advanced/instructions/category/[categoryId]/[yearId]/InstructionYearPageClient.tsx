        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {language === "ar"
                ? `تعليمات الأمن السيبراني لعام ${initialYear.year}`
                : `Cybersecurity Instructions for ${initialYear.year}`}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground">
              {language === "ar"
                ? `جميع التعليمات الخاصة بـ${categoryTitle} لعام ${initialYear.year}`
                : `All instructions for ${categoryTitle} for the year ${initialYear.year}`}
            </p>
            {data && (
        ...
        {loading ? (
          ...
          <Card className="text-center py-12">
            <CardContent>
              ...
              <p className="text-muted-foreground">
                {language === "ar"
                  ? `لا توجد تعليمات متاحة لـ${categoryTitle} في عام ${initialYear.year}`
                  : `No instructions available for ${categoryTitle} in ${initialYear.year}`}
              </p>
            </CardContent>
          </Card>
        )}
