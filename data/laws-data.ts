...
export const lawsData: Law[] = [
  ...
  },
  {
    ...
    category: "executive-regulations",
    description: {
      ar: "إجراءات التحكم الأساسية للأمن السيبراني الصادرة عن الهيئة الوطنية للأمن السيبراني",
  ...
  },
  {
    ...
    content: {
      ar: `<p>المقدمة</p>
      <p>يهدف هذا الإطار إلى تحديد المتطلبات التنظيمية للأمن السيبراني للأنظمة الحساسة في القطاعات الحيوية، وذلك لإجراء حماية استمرارية الأعمال وحماية المصالح الوطنية.</p>
      <p>نطاق التطبيق</p>
