    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 w-11/12 sm:w-3/4 md:w-1/2 lg:w-2/5 max-w-lg rounded-xl p-6 shadow-2xl text-center"
        ...
        >
          ...
          {/* Button */}
          <Button onClick={() => setOpen(false)} className="font-bold px-8 bg-amber-500 hover:bg-amber-400 text-white">
            {t("common.understood")}
          </Button>
        </motion.div>
      </motion.div>
