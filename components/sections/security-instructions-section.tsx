...
export default function SecurityInstructionsSection() {
  ...
  const instructionTypes = [
    {
      ...
      title: { ar: "مج 99", en: "Group 99" },
      description: {
        ar: "تعليمات الأمن السيبراني للمجموعة",
        en: "Group cybersecurity instructions",
      },
      years: Object.keys(instructionsData.group).sort(
    ...
    },
    {
      ...
      title: { ar: "فرع حرب المعلومات", en: "Branch of Information Warfare" },
      description: {
        ar: "تعليمات الأمن السيبراني للفرع",
        en: "Branch cybersecurity instructions",
      },
      years: Object.keys(instructionsData.branch).sort(
        (a, b) => Number(b) - Number(a)
      ),
    },
  ];
  ...
  const selectedTypeData = selectedType
    ? instructionTypes.find((type) => type.id === selectedType)
    : null;
